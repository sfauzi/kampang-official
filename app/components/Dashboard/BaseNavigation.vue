    ...
    <div class="flex items-center justify-between h-16 px-4 lg:px-6">
      ...
      <div class="flex items-center gap-3">
        <button
          ...
          :class="isDark ? 'hover:bg-stone-800 text-stone-300' : 'hover:bg-stone-100 text-stone-600'"
        ...
        <NuxtLink to="/dashboard" class="hidden sm:flex items-center">
          <NuxtImg src="/logo-ko.png" class="max-h-8 w-auto object-contain block" :style="{ maxWidth: '160px' }" />
        </NuxtLink>
      </div>
      ...
      <div class="flex items-center gap-1 sm:gap-2">
        ...
        >
          ...
          <span class="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-brand ring-2"
        ...
        <div class="relative" ref="profileRef">
          ...
          >
            ...
            <svg
              ...
              :class="[isDark ? 'text-stone-500' : 'text-stone-400', profileOpen ? 'rotate-180' : '']"
              fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
            >
          ...
          >
            <div
              ...
              :class="isDark ? 'bg-stone-900 border-stone-700 shadow-black/40' : 'bg-white border-stone-200 shadow-stone-200/60'"
            >
              <!-- User info header -->
              <div class="px-4 py-3 border-b" :class="isDark ? 'border-stone-700' : 'border-stone-100'">
                <p class="text-sm font-semibold font-Manrope truncate" :class="isDark ? 'text-stone-100' : 'text-stone-800'">
                  {{ user?.name ?? '—' }}
                </p>
                <p class="text-xs mt-0.5 truncate" :class="isDark ? 'text-stone-500' : 'text-stone-400'">
                  {{ user?.email ?? '—' }}
                </p>
              </div>
              ...
              <div class="py-1">
                <NuxtLink
                  ...
                  :class="isDark ? 'text-stone-300 hover:bg-stone-800 hover:text-brand' : 'text-stone-600 hover:bg-amber-50 hover:text-brand-dark'"
                >
              ...
              <!-- Logout -->
              <div class="border-t py-1" :class="isDark ? 'border-stone-700' : 'border-stone-100'">
                <button
